...
import br.edu.imepac.commons.repositories.administrativo.AtendenteRepository;
...
class AtendenteServiceTest {
    ...
    @Test
    void saveDeveLancarExcecaoQuandoUsuarioJaExistir() {
        ...
        assertThrows(IllegalStateException.class, () -> atendenteService.save(novo));
