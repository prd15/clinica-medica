...
## Slash commands
- /implementar-modulo [Nome] [microsservico] → ciclo completo: implementa + revisa + documenta
- /status-projeto → mostra estado de implementacao de todos os modulos
- /documentar-tudo → regera toda documentacao no Obsidian
