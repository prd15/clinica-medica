...
class ConsultaServiceTest {
    ...
    @Test
    void testAgendar_ConflitoDentroDoSlotDe30Minutos_LancaBusinessException() {
        ConsultaEntity nova = novaConsulta(null, null);
    ...
    @Test
    void testAgendar_DataNoPassado_LancaBusinessException() {
        ConsultaEntity nova = novaConsulta(null, null);
    ...
    @Test
    void testConfirmar_ConsultaCancelada_LancaBusinessException() {
    ...
    @Test
    void testCancelar_ConsultaRealizada_LancaBusinessException() {
    ...
    @Test
    void testReagendar_ConsultaCancelada_LancaBusinessException() {
        ConsultaEntity cancelada = novaConsulta(1L, StatusConsulta.CANCELADA);
        when(consultaRepository.findById(1L)).thenReturn(Optional.of(cancelada));
    ...
    @Test
    void testRealizar_ConsultaCancelada_LancaBusinessException() {
        ConsultaEntity cancelada = novaConsulta(1L, StatusConsulta.CANCELADA);
        when(consultaRepository.findById(1L)).thenReturn(Optional.of(cancelada));
    ...
    @Test
    void testRealizar_ConsultaJaRealizada_LancaBusinessException() {
        ConsultaEntity realizada = novaConsulta(1L, StatusConsulta.REALIZADA);
        when(consultaRepository.findById(1L)).thenReturn(Optional.of(realizada));
