...
import br.edu.imepac.administrativo.especialidade.EspecialidadeRepository;
...
class MedicoServiceTest {
    ...
    @Test
    void updateDeveLancarBusinessException_quandoCrmPertenceAOutroMedico() {
        MedicoEntity existente = buildMedico(1L, "Dr. João", "CRM-1");
        ...
        assertThrows(BusinessException.class, () -> medicoService.update(1L, dados));
        verify(medicoRepository, never()).save(any());
    }
    ...
    @Test
    void associarEspecialidadeDeveLancarBusinessException_quandoJaAssociada() {
        EspecialidadeEntity especialidade = new EspecialidadeEntity(1L, "Cardiologia", "Desc");
        MedicoEntity medico = buildMedico(1L, "Dr. João", "CRM-1");
